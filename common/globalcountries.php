...
<br/><center><b>Global Country Stats</b></center><br/>
</td></tr>
</table>
<table width="100%" border="0">
<tr><td>
<br/>
<center>These are the countries players from these servers reside in and the stats for the top 10 most common countries.</center>
<br/>
</td></tr>
</table>
</div>
...
else
{
	...
	while($Country_r = @mysqli_fetch_assoc($Country_q))
	{
		...
		<th width="20%" style="text-align:left;"><a href="' . $_SERVER['PHP_SELF'] . '?globalcountries=1&amp;rank=SoldierName&amp;order=';
		if($rank != 'SoldierName')
		{
			echo 'ASC';
		}
		...
		<th width="15%" style="text-align:left;"><a href="' . $_SERVER['PHP_SELF'] . '?globalcountries=1&amp;rank=Score&amp;order=';
		if($rank != 'Score')
		{
			echo 'DESC';
		}
		...
		<th width="15%" style="text-align:left;"><a href="' . $_SERVER['PHP_SELF'] . '?globalcountries=1&amp;rank=Rounds&amp;order=';
		if($rank != 'Rounds')
		{
			echo 'DESC';
		}
		...
		<th width="15%" style="text-align:left;"><a href="' . $_SERVER['PHP_SELF'] . '?globalcountries=1&amp;rank=Kills&amp;order=';
		if($rank != 'Kills')
		{
			echo 'DESC';
		}
		...
		<th width="15%" style="text-align:left;"><a href="' . $_SERVER['PHP_SELF'] . '?globalcountries=1&amp;rank=Deaths&amp;order=';
		if($rank != 'Deaths')
		{
			echo 'DESC';
		}
		...
		<th width="15%" style="text-align:left;"><a href="' . $_SERVER['PHP_SELF'] . '?globalcountries=1&amp;rank=KDR&amp;order=';
		if($rank != 'KDR')
		{
			echo 'DESC';
		}
		...
		else
		{
			while($CountryRank_r = @mysqli_fetch_assoc($CountryRank_q))
			{
				...
				<td width="20%" class="tablecontents" style="text-align: left;"><a href="' . $_SERVER['PHP_SELF'] . '?globalsearch=1&amp;PlayerID=' . $PlayerID . '">' . $SoldierName . '</a></td>
