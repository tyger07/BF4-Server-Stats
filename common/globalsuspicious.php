...
<br/><center><b>Global Suspicious Players</b></center><br/>
</td></tr>
</table>
<table width="100%" border="0">
<tr><td>
...
else
{
	...
	<th width="18%" style="text-align:left;"><a href="' . $_SERVER['PHP_SELF'] . '?globalsuspicious=1&amp;rank=SoldierName&amp;order=';
	if($rank != 'SoldierName')
	{
		echo 'ASC';
	}
	...
	<th width="18%" style="text-align:left;"><a href="' . $_SERVER['PHP_SELF'] . '?globalsuspicious=1&amp;rank=KDR&amp;order=';
	if($rank != 'KDR')
	{
		echo 'DESC';
	}
	...
	<th width="18%" style="text-align:left;"><a href="' . $_SERVER['PHP_SELF'] . '?globalsuspicious=1&amp;rank=HSR&amp;order=';
	if($rank != 'HSR')
	{
		echo 'DESC';
	}
	...
	<th width="18%" style="text-align:left;"><a href="' . $_SERVER['PHP_SELF'] . '?globalsuspicious=1&amp;rank=Rounds&amp;order=';
	if($rank != 'Rounds')
	{
		echo 'DESC';
	}
	...
	while($Suspicious_r = @mysqli_fetch_assoc($Suspicious_q))
	{
		...
		<td width="25%" class="tablecontents" style="text-align: left;"><a href="' . $_SERVER['PHP_SELF'] . '?globalsearch=1&amp;PlayerID=' . $PlayerID . '">' . $SoldierName . '</a></td>
