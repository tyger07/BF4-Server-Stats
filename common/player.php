...
elseif($SoldierName != null AND $SoldierName != 'Not Found')
{
	...
	if($soldier_found == 1)
	{
		...
		if(@mysqli_num_rows($Weapon_q) != 0)
		{
			...
			if(isset($ServerID) AND !is_null($ServerID))
			{
				...
				Statsout("Designated Marksman Rifle Stats","dmr",$SoldierName, $PlayerID, $ServerID, $BF4stats);
			...
			else
			{
				...
				Statsout("Designated Marksman Rifle Stats","dmr",$SoldierName, $PlayerID, null, $BF4stats);
	...
	if($soldier_found == 1)
	{
		...
		<br/><br/>
		[URL="http://' . $_SERVER['HTTP_HOST'] . $_SERVER['PHP_SELF'] . '?globalsearch=1&amp;PlayerID=' . $PlayerID . '"][IMG]' . $URL . '/signature/cache/PID' . $PlayerID . 'FAV0.png[/IMG][/URL]<br/>
		</td>
		</tr>
		<tr>
		<td style="text-align: left">
		...
		<font class="information">Forum BBcode:</font>
		<br/><br/>
		[URL="http://' . $_SERVER['HTTP_HOST'] . $_SERVER['PHP_SELF'] . '?globalsearch=1&amp;PlayerID=' . $PlayerID . '"][IMG]' . $URL . '/signature/cache/PID' . $PlayerID . 'FAV1.png[/IMG][/URL]<br/><br/>
		</td>
		</tr>
		</table>
		<br/>
