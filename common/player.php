...
elseif($SoldierName != null AND $SoldierName != 'Not Found')
{
	...
	else
	{
		...
		// input as: server id, soldier, metric (parameter), order, width, db
		rank($ServerID, $SoldierName, 'Score', 'DESC', '16', $BF4stats);
		rank($ServerID, $SoldierName, 'Kills', 'DESC', '16', $BF4stats);
		rank($ServerID, $SoldierName, 'Killstreak', 'DESC', '17', $BF4stats);
		rank($ServerID, $SoldierName, '(Kills/Deaths)', 'DESC', '17', $BF4stats);
		rank($ServerID, $SoldierName, 'Headshots', 'DESC', '17', $BF4stats);
		rank($ServerID, $SoldierName, '(Headshots/Kills)', 'DESC', '17', $BF4stats);
		echo '
		</tr>
		</table>
		<br/>
